...
public class ProyectoUbicacionVo {
    ...
    public ProyectoUbicacionVo() {
    }

    public ProyectoUbicacionVo(Integer idProyecto, String constructora, Double numeroHabitaciones, String ciudad) {
